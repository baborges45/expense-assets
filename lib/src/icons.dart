  ...
  class ExpenseIcons {
        ...
        static ExpenseIconData get pregnantWomen => ExpenseIconData(
          path: 'lib/src/assets/icons/pregnant-women.svg',
          package: 'expense_assets',
          name: 'PregnantWomen',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get walletOutline => ExpenseIconData(
          path: 'lib/src/assets/icons/wallet-outline.svg',
          package: 'expense_assets',
          name: 'WalletOutline',
          height: 11,
          width: 10,
        ...
        static ExpenseIconData get restaurant => ExpenseIconData(
          path: 'lib/src/assets/icons/restaurant.svg',
          package: 'expense_assets',
          name: 'Restaurant',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get dollar => ExpenseIconData(
          path: 'lib/src/assets/icons/dollar.svg',
          package: 'expense_assets',
          name: 'Dollar',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get shop => ExpenseIconData(
          path: 'lib/src/assets/icons/shop.svg',
          package: 'expense_assets',
          name: 'Shop',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get carSideview => ExpenseIconData(
          path: 'lib/src/assets/icons/car-sideview.svg',
          package: 'expense_assets',
          name: 'CarSideview',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get shopping => ExpenseIconData(
          path: 'lib/src/assets/icons/shopping.svg',
          package: 'expense_assets',
          name: 'Shopping',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get financeMoney => ExpenseIconData(
          path: 'lib/src/assets/icons/finance-money.svg',
          package: 'expense_assets',
          name: 'FinanceMoney',
          height: 8,
          width: 8,
        ...
        static ExpenseIconData get giftOutline => ExpenseIconData(
          path: 'lib/src/assets/icons/gift-outline.svg',
          package: 'expense_assets',
          name: 'GiftOutline',
          height: 8,
          width: 7,
        ...
        static ExpenseIconData get plane => ExpenseIconData(
          path: 'lib/src/assets/icons/plane.svg',
          package: 'expense_assets',
          name: 'Plane',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get medkit => ExpenseIconData(
          path: 'lib/src/assets/icons/medkit.svg',
          package: 'expense_assets',
          name: 'Medkit',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get cash100 => ExpenseIconData(
          path: 'lib/src/assets/icons/cash-100.svg',
          package: 'expense_assets',
          name: 'Cash100',
          height: 8,
          width: 7,
        ...
        static ExpenseIconData get fiBrGraduationCap => ExpenseIconData(
          path: 'lib/src/assets/icons/fi-br-graduation-cap.svg',
          package: 'expense_assets',
          name: 'FiBrGraduationCap',
          height: 24,
          width: 24,
        );
        ...
        static ExpenseIconData get finance => ExpenseIconData(
          path: 'lib/src/assets/icons/finance.svg',
          package: 'expense_assets',
          name: 'Finance',
          height: 8,
          width: 8,
        ...
        static ExpenseIconData get dogSolid => ExpenseIconData(
          path: 'lib/src/assets/icons/dog-solid.svg',
          package: 'expense_assets',
          name: 'DogSolid',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get babyCarriage => ExpenseIconData(
          path: 'lib/src/assets/icons/baby-carriage.svg',
          package: 'expense_assets',
          name: 'BabyCarriage',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get fiBrDollar => ExpenseIconData(
          path: 'lib/src/assets/icons/fi-br-dollar.svg',
          package: 'expense_assets',
          name: 'FiBrDollar',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get moneyAlt => ExpenseIconData(
          path: 'lib/src/assets/icons/money-alt.svg',
          package: 'expense_assets',
          name: 'MoneyAlt',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get gift => ExpenseIconData(
          path: 'lib/src/assets/icons/gift.svg',
          package: 'expense_assets',
          name: 'Gift',
          height: 8,
          width: 7,
        ...
        static ExpenseIconData get statistic => ExpenseIconData(
          path: 'lib/src/assets/icons/statistic.svg',
          package: 'expense_assets',
          name: 'Statistic',
          height: 24,
          width: 24,
        ...
        static ExpenseIconData get weightLifter => ExpenseIconData(
          path: 'lib/src/assets/icons/weight-lifter.svg',
          package: 'expense_assets',
          name: 'WeightLifter',
          height: 7,
          width: 8,
  ...
  ExpenseIcons.pregnantWomen,
  ExpenseIcons.dislikeFill,
  ExpenseIcons.walletOutline,
  ExpenseIcons.gym,
  ExpenseIcons.restaurant,
  ExpenseIcons.sendFill,
  ExpenseIcons.dollar,
  ExpenseIcons.shop,
  ExpenseIcons.androidFill,
  ExpenseIcons.carSideview,
  ExpenseIcons.shopping,
  ...
  ExpenseIcons.financeMoney,
  ExpenseIcons.giftOutline,
